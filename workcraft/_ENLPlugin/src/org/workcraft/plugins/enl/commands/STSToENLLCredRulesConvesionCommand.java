...
public class STSToENLLCredRulesConvesionCommand extends AbstractConversionCommand {

    @Override
    public String getDisplayName() {
        return "Net synthesis-[Check if ts can be synthesised to an ENL/LC-system and if so construct a solution based on "
                + "\u224F" + "^{ts}_{min}, and apply reduction rules]";
    }
