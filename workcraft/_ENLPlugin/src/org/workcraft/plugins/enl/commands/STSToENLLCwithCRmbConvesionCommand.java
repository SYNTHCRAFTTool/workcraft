...
public class STSToENLLCwithCRmbConvesionCommand extends AbstractConversionCommand {

    @Override
    public String getDisplayName() {
        return "Net synthesis-[Check if ts can be synthesised to an ENL/LC-system and if so construct a solution satisfying criteria 1 & 2]";
    }
