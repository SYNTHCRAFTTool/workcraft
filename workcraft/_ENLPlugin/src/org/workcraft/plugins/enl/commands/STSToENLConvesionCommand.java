...
public class STSToENLConvesionCommand extends AbstractConversionCommand {

    @Override
    public String getDisplayName() {
        return "Net synthesis-[Method I: by checking axioms A1-A4 for an ST-system]";
    }
    ...
    public ModelEntry convert(ModelEntry me) {
        ...
        final STSToENLConverter converter = new STSToENLConverter(sts,false);
...
//                System.out.println("Execution time way 1 is " + time + " MilliSeconds");
                STS.recordTime(time);
                DialogUtils
                        .showInfo("The given ts satisfies axioms A1-A4 w.r.t " + "\u224F" + STS.getCoRe() + ". So, it can be synthesised to an ENL_{"+ "\u224F" + "}-system.", "Result");
